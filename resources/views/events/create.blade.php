              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="{{route('event.store')}}" method="POST">
                    ...
                    <br>
                    @enderror 
                      <input type="text" class="form-control" id="title" name="title" placeholder="Enter event title..." style="font-size:18px;">
                    </div>  
                    ...
                    <br>
                    @enderror
                      <textarea rows="5" cols="30" class="form-control" id="description" name="description" placeholder="Enter event description..." style="font-size:18px;"></textarea>
                    </div>  
                    ...
                    @enderror 
                    <div class="form-group">
                      <input type="date" class="form-control" id="date" name="date" placeholder="Enter event date..." style="font-size:18px;" />
                    </div>  
                    ...
                    @enderror
                    <div class="form-group">
                      <input type="time" class="form-control" id="time" name="time" placeholder="Enter event time..." style="font-size:18px;" />
                    </div>  
                    ...
                    @enderror 
                    <div class="form-group">
                      <input type="text" class="form-control" id="time" name="location" placeholder="Enter event location..." style="font-size:18px;" />
                    </div>  
